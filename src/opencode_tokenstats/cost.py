...
class CostSummary:
    ...
    estimated_web_search_cost: float
...
def calculate_cost_summary(
    ...
    *,
    ...
    estimated_web_search_cost = telemetry.web_search_requests * pricing.web_search
    ...
    has_activity = telemetry.api_calls > 0 and (
        ...
        or telemetry.web_search_requests > 0
    )
    ...
    return CostSummary(
        ...
        estimated_web_search_cost=estimated_web_search_cost,
